...
class DonateForm extends Component {
  ...
  donate = async (formValues) => {
    ...
    try {
      ...
      const responseStream = await fetch('/api/donations/make', {
        method: 'POST',
        body: JSON.stringify({
          source: token,
          firstName,
    ...
    return (
      ...
      >
        {({
          ...
          const h = (e) => handleSubmit(e)
          return (
            <Form className='flex flex-column f4-m ph2' onSubmit={h}>
              ...
              <div className='bg-white bn ba pa3 mb2'>
                <PaymentElement options={{ }} handleChange={handleChange} name='cardNumber' />
              </div>
